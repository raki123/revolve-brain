...
public:
	...
	Gene(int innov_number = 0, bool enabled = true, std::string parent_name = "", int parent_index = -1) 
	...
	virtual inline std::string get_parent_name() { return this->parent_name; }
	virtual inline int get_parent_index() { return this->parent_index; }
	GeneType gene_type;
private:
	int innov_number;
	bool enabled;
