...
public:
	ConnectionGene(int mark_to, int mark_from, double weight, int innov_number = 0, bool enabled = true, std::string parent_name = "", int parent_index = -1, std::string socket = "") 
